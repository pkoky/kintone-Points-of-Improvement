...
## 今回書く理由
　kintoneを無料期間で使ってみたところ、とても使いやすく多くの人が必要とするアプリケーションだと感じました。kintoneを使ってみて、初心者ユーザーの視点から気になった部分がありました。更にいい製品にするための役に立てればと思い、感じたことをまとめることにしました。すでに把握されていて織り込み済みのものばかりであれば申し訳ございません。
...
## 提案
- 「何も追加などされていない場合のみ保存されないようにする」はどうでしょうか。
